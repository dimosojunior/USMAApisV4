    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CreatedBy', models.CharField(default='Dimoso Junior', max_length=100)),
                ...
                ('Created', models.DateTimeField(auto_now_add=True)),
                ('Updated', models.DateTimeField(auto_now=True)),
                ('Category', models.ForeignKey(max_length=1000, on_delete=django.db.models.deletion.CASCADE, to='USMAApp.peopleworkscategory')),
            ],
            options={
